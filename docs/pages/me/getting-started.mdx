...
![](https://manifest-editor-docs.netlify.app/img/theseus-iiif-link.jpg)
...
<video
  src="https://manifest-editor-docs.netlify.app/open-file.mp4"
  loop
  muted
  controls
  playsInline
...
This will open a new blank manifest in the editor, where you can start [adding resources](/me/adding-resources) and [editing the manifest](#basic-editing).
...
<video
  src="https://manifest-editor-docs.netlify.app/editing-label.mp4"
  loop
  muted
  controls
  playsInline
...
<video
  src="https://manifest-editor-docs.netlify.app/preview.mp4"
  loop
  muted
  controls
  playsInline
