...
![Create a new manifest](https://digirati-workshops.pages.dev/create-manifest-step1.PNG)
...
![Manifest portal view](https://digirati-workshops.pages.dev/create-manifest-step2.PNG)
...
![Navigate to your spaces](https://digirati-workshops.pages.dev/create-manifest-step3.PNG)

Browse to the appropriate Space, and select the assets you wish to add, and Click ‘Add’.

![Select your images](https://digirati-workshops.pages.dev/create-manifest-step4.PNG)

Your selected images should now appear as a canvas within your Manifest. 

![Your images added as canvases](https://digirati-workshops.pages.dev/create-manifest-step5.PNG)
...
![Basic manifest edit](https://digirati-workshops.pages.dev/edit-manifest-step1.PNG)
...
![Opening the manifest in ME](https://digirati-workshops.pages.dev/edit-manifest-step2.PNG)
...
![Edit canvas in ME](https://digirati-workshops.pages.dev/edit-manifest-step3.PNG)
...
![Edit canvas order in ME](https://digirati-workshops.pages.dev/edit-manifest-step5.PNG)
...
![Add required statement in ME](https://digirati-workshops.pages.dev/edit-manifest-step6.PNG)

Label could be “Attribution”, and Value something relevant to the image(s) you are adding to Manifest.

![Required statement in ME](https://digirati-workshops.pages.dev/edit-manifest-step7.PNG)
