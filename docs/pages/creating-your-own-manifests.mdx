...
![Manifest portal view](https://digirati-tanc-workshops.pages.dev/create-manifest-step2.PNG)
...
![Edit canvas label in ME](https://digirati-tanc-workshops.pages.dev/edit-manifest-step4.PNG)
