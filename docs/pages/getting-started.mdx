...
:::warning Need to add the Trial homepage screenshot without the 'Register' link
:::
...
:::warning Need to add the Trial homepage screenshot without the 'Register' link and highlight the link
:::
